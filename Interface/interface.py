...
class MplCanvas(FigureCanvasQTAgg):
    ...
    def __init__(
            ...
            dpi: int=100,scale: Literal["both","x","y"] = "both",
            visible: bool = False):
        figure = Figure()
        if size is not None:
            figure.set_figheight(size[0])
    ...
    def latex(
            ...
            font_color: str="w") -> QtGui.QPixmap:
        ...
        t = ax.text(0, 0, f"{text}", ha='left', va='bottom', 
                    fontsize=font_size, c=font_color)
...
class BasicDialog(QDialog):
    ...
    def __init__(
            self, parent: QMainWindow, title: str = "Dialog", 
            **kwargs
        ):
